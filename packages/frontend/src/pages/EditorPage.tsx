...
type Tab = 'persons' | 'families' | 'users'
      ...
      <div className="flex-1 flex overflow-hidden">
        {tab === 'persons' ? (
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <UsersPanel persons={persons} authHeaders={authHeaders} />
          </div>
        )}
      </div>
    </div>
...
function UsersPanel({ persons, authHeaders }: { persons: PersonFull[]; authHeaders: Record<string, string> }) {
